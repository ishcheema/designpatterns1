...
public class BookDriver {
    ...
    public void run() {
        ...
        Store store = new Store(bestSellers);
        FanReads fanReads = new FanReads(bestSellers, "Amy", "Smith");

        bestSellers.addBook("The Edge", Genre.THRILLER, "David", "Baldacci", "The 6:20 Man is back, dropped by his handlers into a small coastal town in Maine to solve the murder of a CIA agent who knew America’s dirtiest secrets—can Travis Devine uncover the truth before his time runs out?");
        ...
        displayStoreBooks(store);

        System.out.println("\n***** Favorite Thrillers *****");
        displayFanReads(Genre.THRILLER, fanReads);

        System.out.println("\n***** Favorite Mysteries *****");
        displayFanReads(Genre.MYSTERY, fanReads);
